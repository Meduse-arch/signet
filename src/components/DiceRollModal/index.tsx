        ...
        {diceResult && rollInfo && (
          <ModalContainer onClose={() => setDiceResult(null)} title="Appel du Destin">
            <div className="flex flex-col items-center gap-3 py-4">
              {phase !== 'reveal' ? (
                <span className={`font-cinzel leading-none transition-all duration-300 ${
                  phase === 'rune' 
                    ? 'text-6xl text-gold-bright drop-shadow-[0_0_20px_rgba(212,175,55,0.8)]' 
                    : 'text-5xl text-gold-DEFAULT opacity-40'
                }`}>{displayRune}</span>
              ) : (
                <div className="flex flex-col items-center gap-1 animate-in fade-in duration-300">
                  <span className="text-2xl font-cinzel text-gold-bright opacity-70 animate-pulse drop-shadow-[0_0_10px_rgba(212,175,55,0.6)]">{rollInfo.char}</span>
                  <div className="relative flex items-center justify-center">
                    ...
                    <span className="relative text-7xl font-cinzel font-black text-gold-bright drop-shadow-[0_0_15px_rgba(212,175,55,0.3)] leading-none z-10">{totalGlobal}</span>
                  </div>
                  <div className="mt-2">
