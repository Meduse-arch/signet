...
export function JukeboxManager({ sessionId, onClose, audioSync }: JukeboxManagerProps) {
 ...
 <label className="cursor-pointer text-silver-bright/70 hover:text-silver-bright flex items-center gap-1 text-xs">
 ...
 <div className="w-8 h-8 shrink-0 rounded-md bg-glacier-DEFAULT/10 flex items-center justify-center">
 <Music size={14} className="text-silver-bright" />
 </div>
 <div className="flex flex-col min-w-0">
 <span className="text-xs text-white/90 font-quantico truncate tracking-wide">{uploadingState.name}</span>
 ...
 return (
 <div key={t.hash} className="flex items-center justify-between p-2 rounded-lg bg-white/5 border border-white/5 hover:border-silver-DEFAULT/30 transition-all group">
 <div className="flex items-center gap-3 overflow-hidden">
 ...
 <div className="w-8 h-8 rounded-md bg-glacier-DEFAULT/10 flex items-center justify-center shrink-0 border border-silver-DEFAULT/20 group-hover:bg-glacier-DEFAULT/20 transition-colors">
 <Music size={14} className="text-silver-bright" />
 </div>
 <div className="flex flex-col min-w-0">
 ...
 className={`w-6 h-6 flex items-center justify-center rounded-full transition-all bg-glacier-DEFAULT/20 text-silver-bright hover:bg-glacier-DEFAULT hover:text-black`}
 title="Jouer"
 >
