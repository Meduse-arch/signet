...
export function SealSettingsModal({ isOpen, onClose, settings, onSave }: SealSettingsModalProps) {
 ...
 className={`px-4 py-3 text-[11px] font-quantico font-black tracking-widest uppercase transition-all border-b-2 whitespace-nowrap ${activeTab === 'creation' ? 'border-silver-DEFAULT text-glacier-bright' : 'border-transparent text-gold-muted hover:text-silver-bright'}`}
 >
 {t('seal.creation', 'Création')}
 </button>
 <button 
 onClick={() => setActiveTab('stats')}
 className={`px-4 py-3 text-[11px] font-quantico font-black tracking-widest uppercase transition-all border-b-2 whitespace-nowrap ${activeTab === 'stats' ? 'border-silver-DEFAULT text-glacier-bright' : 'border-transparent text-gold-muted hover:text-silver-bright'}`}
 >
 {t('seal.attributes', 'Attributs')}
 </button>
 <button 
 onClick={() => setActiveTab('bars')}
 className={`px-4 py-3 text-[11px] font-quantico font-black tracking-widest uppercase transition-all border-b-2 whitespace-nowrap ${activeTab === 'bars' ? 'border-silver-DEFAULT text-glacier-bright' : 'border-transparent text-gold-muted hover:text-silver-bright'}`}
 >
 ...
 <h3 className="text-xs font-quantico font-black text-gold-muted tracking-widest uppercase">{t('seal.creationMethod', 'Méthode de Création')}</h3>
 </div>
 ...
 : 'text-gold-muted hover:text-silver-bright'
 }`}
 >
 ...
 <label className="block text-xs font-quantico font-black text-gold-muted tracking-widest uppercase mb-4">{t('seal.pointPool', 'Réserve de Points')}</label>
 ...
 <p className="mt-4 text-[11px] text-gold-muted/50 font-inter italic leading-relaxed">
 ...
 <label className="block text-xs font-quantico font-black text-gold-muted tracking-widest uppercase mb-6 text-center">{t('seal.rollFormula', 'Formule de Tirage')}</label>
 ...
 <p className="mt-8 text-[11px] text-gold-muted/50 font-inter italic leading-relaxed max-w-sm mx-auto">
 ...
 <p className="text-xs text-gold-muted font-inter italic">{t('seal.rerollAllDesc', "Permettre de relancer toute la fiche d'un coup.")}</p>
 </div>
 <button
 ...
 <h3 className="text-xs font-quantico font-black text-gold-muted tracking-widest uppercase">{t('seal.customAttributes', 'Attributs Personnalisés')}</h3>
 <Button 
 size="sm"
 variant="ghost"
 ...
 <div className="flex justify-between items-center mb-4">
 <h3 className="text-xs font-quantico font-black text-gold-muted tracking-widest uppercase">{t('seal.formulas', 'Formules de Calcul (Ressources)')}</h3>
 <Button 
 size="sm"
 variant="ghost"
 leftIcon={<Icons.Plus size={14} />}
