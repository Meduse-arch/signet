...
export function CreateSessionModal({ 
  ...
  return (
    ...
    >
      <div 
        className="bg-[#111115] border border-gold-DEFAULT/40 rounded-[2rem] p-8 w-full max-w-sm shadow-[0_0_50px_rgba(0,0,0,0.8)] relative overflow-hidden group pointer-events-auto"
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-xs font-serif italic text-gold-DEFAULT drop-shadow-md/80 mb-8 leading-relaxed">
            {initialData 
          ...
          <div className="space-y-6 mb-10">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-[#0D0D0F]/80 border border-gold-DEFAULT/30 rounded-xl py-3 px-4 text-sm text-gold-bright focus:outline-none focus:border-gold-DEFAULT/50 focus:ring-1 focus:ring-gold-DEFAULT/30 transition-all placeholder:text-gold-DEFAULT drop-shadow-md/30 font-serif italic"
              />
            </div>
            ...
            <div className="space-y-1.5 relative" ref={dropdownRef}>
              ...
              <div className="relative group">
                <input
                  ...
                  className="w-full bg-[#0D0D0F]/80 border border-gold-DEFAULT/30 rounded-xl py-3 pl-4 pr-10 text-sm text-gold-bright focus:outline-none focus:border-gold-DEFAULT/50 focus:ring-1 focus:ring-gold-DEFAULT/30 transition-all placeholder:text-gold-DEFAULT drop-shadow-md/30 font-serif italic"
                />
                <div 
            ...
            {system.toLowerCase() === 'seal' && (
              <div className="animate-in fade-in slide-in-from-left-2 duration-300">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-gold-DEFAULT/5 border border-gold-DEFAULT/40 rounded-xl text-[10px] font-cinzel font-black text-gold-bright hover:bg-gold-DEFAULT/10 transition-all tracking-widest uppercase"
                >
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-[#0D0D0F]/80 border border-gold-DEFAULT/30 rounded-xl py-3 px-4 text-sm text-gold-bright focus:outline-none focus:border-gold-DEFAULT/50 focus:ring-1 focus:ring-gold-DEFAULT/30 transition-all placeholder:text-gold-DEFAULT drop-shadow-md/30 font-mono text-[10px]"
              />
            </div>
          </div>
          ...
          <div className="flex gap-4">
            <button
              onClick={onClose}
              className="flex-1 py-3 text-[10px] font-cinzel font-black tracking-widest border border-gold-DEFAULT/30 rounded-xl text-gold-DEFAULT drop-shadow-md hover:text-gold-bright hover:bg-white/5 transition-all"
            >
              ANNULER
            </button>
            <button
