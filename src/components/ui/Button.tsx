...
const variantStyles: Record<ButtonVariant, string> = {
  primary: [
    ...
    'shadow-[0_4px_20px_rgba(212,160,23,0.2)] hover:shadow-[0_4px_30px_rgba(212,160,23,0.45)]',
  ].join(' '),

  secondary: [
    'bg-gold-DEFAULT/5 text-gold-bright border border-gold-DEFAULT/30',
    'hover:bg-gold-DEFAULT/15 hover:border-gold-DEFAULT/60',
  ...
  ghost: [
    'bg-transparent text-gold-DEFAULT/80',
    'hover:text-gold-bright hover:bg-gold-DEFAULT/5',
...
const fontStyles: Record<ButtonVariant, string> = {
  primary: 'font-cinzel font-black tracking-widest uppercase',
  secondary: 'font-cinzel font-black tracking-widest uppercase',
  tertiary: 'font-cinzel font-bold tracking-widest uppercase',
  silver: 'font-cinzel font-black tracking-widest uppercase',
  danger: 'font-cinzel font-black tracking-widest uppercase',
  ghost: 'font-cinzel font-bold tracking-[0.15em] uppercase',
};
