...
export const Input = React.forwardRef<HTMLInputElement, InputProps>(
 ...
 ? 'bg-surface-card border border-silver-DEFAULT/30'
 : 'bg-[#0D0D0F]/80 border border-silver-DEFAULT/30';
 ...
 mono ? 'font-mono tracking-[0.2em] uppercase text-center' : 'font-inter italic',
 ...
 {/* Message d'erreur */}
 {error && (
 <p className="text-red-400 text-[10px] font-quantico tracking-wide ml-1">
 {error}
 </p>
 )}
 </div>
