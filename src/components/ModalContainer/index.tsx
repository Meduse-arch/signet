  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className={`relative w-full max-w-lg bg-[#0D0D0F] border border-gold-DEFAULT/30 rounded-2xl shadow-[0_0_50px_rgba(0,0,0,0.8)] overflow-hidden flex flex-col ${className}`}
        style={{
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-gold-DEFAULT/10 bg-black/20">
          ...
          <button
            onClick={onClose}
            className="p-1 hover:bg-gold-DEFAULT/10 rounded-full transition-colors text-gold-DEFAULT/60 hover:text-gold-bright"
          >
            <X size={18} />
          </button>
        </div>
