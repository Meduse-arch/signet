        ...
        <div className="flex flex-col gap-6 overflow-y-auto custom-scrollbar pr-2">
            ...
            <div className="flex flex-wrap gap-2">
              {DIE_TYPES.map(faces => (
                <button
                  ...
                  className="w-12 h-12 rounded-xl bg-black/40 border border-gold-DEFAULT/30 flex items-center justify-center font-cinzel font-black text-gold-bright hover:scale-110 hover:border-gold-bright transition-all shadow-lg"
                >
                  D{faces}
                </button>
              ))}
          ...
          <section className="liquid-glass-panel p-4 flex flex-col gap-4">
            ...
            <div className="flex items-center gap-4 justify-between">
              <div className="flex flex-col items-center gap-1">
                ...
                <input 
                  ...
                  className="w-12 bg-black/40 border border-white/10 rounded-lg p-2 text-center text-gold-bright font-mono focus:outline-none focus:border-gold-DEFAULT/40"
                />
              </div>
              ...
              <div className="flex flex-col items-center gap-1">
                ...
                <input 
                  ...
                  className="w-14 bg-black/40 border border-white/10 rounded-lg p-2 text-center text-gold-bright font-mono focus:outline-none focus:border-gold-DEFAULT/40"
                />
              </div>
              <div className="flex flex-col items-center gap-1">
            ...
            <button 
              ...
              className="w-full py-3 rounded-xl bg-gold-DEFAULT/10 border border-gold-DEFAULT/30 text-gold-bright font-cinzel font-black uppercase tracking-widest hover:bg-gold-DEFAULT/20 transition-all shadow-inner"
            >
              Interroger l'Oracle
            </button>
          </section>
