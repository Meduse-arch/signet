  ...
  return (
    <div className="absolute inset-0 z-20 bg-[#0D0D0F]/80 flex items-center justify-center backdrop-blur-sm">
      <div className="bg-surface-card border border-[#2a2015] rounded-xl p-6 w-72 shadow-2xl">
        ...
        <p className="text-xs text-gold-DEFAULT drop-shadow-md mb-4">
        ...
        <div className="flex gap-2">
          <button
            onClick={onClose}
            className="flex-1 py-2 text-xs font-medium border border-border-dark rounded-lg text-gold-DEFAULT drop-shadow-md hover:text-gold-bright transition-colors"
          >
            Annuler
          </button>
          <button
