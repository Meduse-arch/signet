...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  getCombatState: (sessionId: string) => ipcRenderer.invoke('combat:getState', sessionId),
  saveCombatState: (sessionId: string, state: any) => ipcRenderer.invoke('combat:saveState', sessionId, state),
});
